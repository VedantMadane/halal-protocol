...
- Pick [standalone PSM health-check tests](https://github.com/fredrikblau/halal-protocol/issues/43)
  or a [local CPI report walkthrough](https://github.com/fredrikblau/halal-protocol/issues/44).
...
| --- | --- |
| Does the accounting have stateful coverage? | 172 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (172/172 at the time of writing — 169 unit
