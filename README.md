...
| --- | --- |
| Does the accounting have stateful coverage? | 160 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (160/160 at the time of writing — 157 unit
