...
| --- | --- |
| Does the accounting have stateful coverage? | 167 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (167/167 at the time of writing — 164 unit
