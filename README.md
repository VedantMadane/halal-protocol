...
| --- | --- |
| Does the accounting have stateful coverage? | 168 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (168/168 at the time of writing — 165 unit
