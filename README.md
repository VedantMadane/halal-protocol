...
- Pick a bounded task from the [open good-first-issue list](https://github.com/fredrikblau/halal-protocol/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22),
  such as [stale CPI safety coverage](https://github.com/fredrikblau/halal-protocol/issues/57) or
  [machine-readable deployment health](https://github.com/fredrikblau/halal-protocol/issues/58).
