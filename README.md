...
| --- | --- |
| Does the accounting have stateful coverage? | 161 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (161/161 at the time of writing — 158 unit
