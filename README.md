...
| --- | --- |
| Does the accounting have stateful coverage? | 163 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (163/163 at the time of writing — 160 unit
