...
| --- | --- |
| Does the accounting have stateful coverage? | 174 Foundry tests, including 3 PSM invariants, differential arithmetic checks, and fuzzing |
...
program yet.** The contracts pass their own test suite (174/174 at the time of writing — 171 unit
