...
/// governance, ERC20Permit for gasless approvals, AccessControl-gated minting so the PSM and any
/// future module (lending, staking, ...) can be granted mint rights by DAO vote without redeploying
/// the token (see AddingFeature.md in the repo docs for the extension pattern).
///
...
contract HalalToken is ERC20, ERC20Burnable, ERC20Permit, ERC20Votes, AccessControl {
