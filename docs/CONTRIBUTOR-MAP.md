...
| Monitoring | [`scripts/check-psm-health.sh`](../scripts/check-psm-health.sh), [`docs/OPERATOR-RUNBOOK.md`](OPERATOR-RUNBOOK.md) | A read-only alert integration that preserves the script's fail-closed exit behavior |
