...
- **Full Test Suite** - 194 tests (183 unit/configuration tests plus 11 stateful PSM invariants) covering the core workflows
...
# ... (194 tests: 183 unit/configuration + 11 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (194/194 local suite)
...
- `contracts/test/` — 194 tests (183 unit/configuration tests plus 11 stateful PSM invariants) and fixtures
