...
- **Full Test Suite** - 190 tests (179 unit/configuration tests plus 11 stateful PSM invariants) covering the core workflows
...
# ... (190 tests: 179 unit/configuration + 11 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (190/190 local suite)
...
- `contracts/test/` — 190 tests (179 unit/configuration tests plus 11 stateful PSM invariants) and fixtures
