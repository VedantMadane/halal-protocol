...
- **Full Test Suite** - 130 tests (127 unit/configuration tests plus 3 stateful PSM invariants) covering the core workflows
...
# ... (130 tests: 127 unit/configuration + 3 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (130/130 local suite)
...
- `contracts/test/` — 130 tests (127 unit/configuration tests plus 3 stateful PSM invariants) and fixtures
