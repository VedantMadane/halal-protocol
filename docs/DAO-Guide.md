...
- **Full Test Suite** - 128 tests (125 unit/configuration tests plus 3 stateful PSM invariants) covering the core workflows
...
# ... (128 tests: 125 unit/configuration + 3 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (128/128 local suite)
...
- `contracts/test/` — 128 tests (125 unit/configuration tests plus 3 stateful PSM invariants) and fixtures
