...
- **Full Test Suite** - 158 tests (155 unit/configuration tests plus 3 stateful PSM invariants) covering the core workflows
...
# ... (158 tests: 155 unit/configuration + 3 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (158/158 local suite)
...
- `contracts/test/` — 158 tests (155 unit/configuration tests plus 3 stateful PSM invariants) and fixtures
