...
- **Full Test Suite** - 161 tests (158 unit/configuration tests plus 3 stateful PSM invariants) covering the core workflows
...
# ... (161 tests: 158 unit/configuration + 3 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (161/161 local suite)
...
- `contracts/test/` — 161 tests (158 unit/configuration tests plus 3 stateful PSM invariants) and fixtures
