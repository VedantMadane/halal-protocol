...
- **Full Test Suite** - 150 tests (147 unit/configuration tests plus 3 stateful PSM invariants) covering the core workflows
...
# ... (150 tests: 147 unit/configuration + 3 invariants) ...
```
...
- [ ] All tests passing locally and on the target network (150/150 local suite)
...
- `contracts/test/` — 150 tests (147 unit/configuration tests plus 3 stateful PSM invariants) and fixtures
