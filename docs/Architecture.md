...
```
Foundry test suite (154 tests: 151 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 154 tests (151 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (154/154 should pass)
