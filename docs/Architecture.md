...
```
Foundry test suite (165 tests: 162 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 165 tests (162 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (165/165 should pass)
