...
```
Foundry test suite (122 tests: 119 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 122 tests (119 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (122/122 should pass)
