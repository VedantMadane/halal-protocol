...
```
Foundry test suite (192 tests: 181 unit/configuration + 11 stateful invariants)
...
| `contracts/test/` | 192 tests (181 unit/configuration + 11 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (192/192 should pass)
