...
```
Foundry test suite (123 tests: 120 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 123 tests (120 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (123/123 should pass)
