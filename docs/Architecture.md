...
```
Foundry test suite (150 tests: 147 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 150 tests (147 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (150/150 should pass)
