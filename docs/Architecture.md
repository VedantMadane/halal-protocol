...
```
Foundry test suite (178 tests: 175 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 178 tests (175 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (178/178 should pass)
