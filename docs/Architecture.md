...
```
Foundry test suite (166 tests: 163 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 166 tests (163 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (166/166 should pass)
