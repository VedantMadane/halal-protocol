...
```
Foundry test suite (161 tests: 158 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 161 tests (158 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (161/161 should pass)
