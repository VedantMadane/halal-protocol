...
```
Foundry test suite (135 tests: 132 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 135 tests (132 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (135/135 should pass)
