...
```
Foundry test suite (174 tests: 171 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 174 tests (171 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (174/174 should pass)
