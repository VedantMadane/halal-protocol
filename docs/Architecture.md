...
```
Foundry test suite (191 tests: 180 unit/configuration + 11 stateful invariants)
...
| `contracts/test/` | 191 tests (180 unit/configuration + 11 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (191/191 should pass)
