...
```
Foundry test suite (179 tests: 176 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 179 tests (176 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (179/179 should pass)
