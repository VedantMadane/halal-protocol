...
```
Foundry test suite (115 tests: 112 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 115 tests (112 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (115/115 should pass)
