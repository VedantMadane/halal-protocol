...
```
Foundry test suite (125 tests: 122 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 125 tests (122 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (125/125 should pass)
