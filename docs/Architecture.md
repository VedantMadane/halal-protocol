...
```
Foundry test suite (163 tests: 160 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 163 tests (160 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (163/163 should pass)
