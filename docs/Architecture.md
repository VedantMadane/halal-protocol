...
```
Foundry test suite (184 tests: 176 unit/configuration + 8 stateful invariants)
...
| `contracts/test/` | 184 tests (176 unit/configuration + 8 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (184/184 should pass)
