...
```
Foundry test suite (189 tests: 178 unit/configuration + 11 stateful invariants)
...
| `contracts/test/` | 189 tests (178 unit/configuration + 11 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (189/189 should pass)
