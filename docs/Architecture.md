...
```
Foundry test suite (193 tests: 182 unit/configuration + 11 stateful invariants)
...
| `contracts/test/` | 193 tests (182 unit/configuration + 11 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (193/193 should pass)
