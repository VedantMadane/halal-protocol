...
```
Foundry test suite (132 tests: 129 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 132 tests (129 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (132/132 should pass)
