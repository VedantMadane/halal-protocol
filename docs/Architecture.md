...
```
Foundry test suite (133 tests: 130 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 133 tests (130 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (133/133 should pass)
