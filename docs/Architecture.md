...
```
Foundry test suite (167 tests: 164 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 167 tests (164 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (167/167 should pass)
