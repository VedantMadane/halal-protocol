...
```
Foundry test suite (159 tests: 156 unit/configuration + 3 stateful invariants)
...
| `contracts/test/` | 159 tests (156 unit/configuration + 3 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (159/159 should pass)
