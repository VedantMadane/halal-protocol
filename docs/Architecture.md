...
```
Foundry test suite (194 tests: 183 unit/configuration + 11 stateful invariants)
...
| `contracts/test/` | 194 tests (183 unit/configuration + 11 stateful PSM invariants) and fixtures |
...
### Immediate (This Week)
1. **Test locally**: `forge test -vvv` ✓ (194/194 should pass)
