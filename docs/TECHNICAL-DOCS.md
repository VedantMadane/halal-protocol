...
**Status**: Unaudited reference implementation | 192 tests passing (181 unit/configuration + 11 invariants) | Not production-ready
...
# 1. Test locally
forge test -vvv
# Expected: 192/192 tests passing ✓
...
- [ ] All 192 tests passing locally, including the stateful invariants
