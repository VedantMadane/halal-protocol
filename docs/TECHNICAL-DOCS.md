...
**Status**: Unaudited reference implementation | 193 tests passing (182 unit/configuration + 11 invariants) | Not production-ready
...
# 1. Test locally
forge test -vvv
# Expected: 193/193 tests passing ✓
...
✓ 180 unit/configuration tests plus 11 stateful PSM invariants covering the core contracts, governance flows, and adversarial reserve boundaries
...
- [ ] All 193 tests passing locally, including the stateful invariants
