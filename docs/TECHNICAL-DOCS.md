...
**Status**: Unaudited reference implementation | 167 tests passing (164 unit/configuration + 3 invariants) | Not production-ready
...
# 1. Test locally
forge test -vvv
# Expected: 167/167 tests passing ✓
...
✓ 164 unit/configuration tests plus 3 stateful PSM invariants covering the core contracts and governance flows
...
- [ ] All 167 tests passing locally, including the stateful invariants
