...
**Status**: Unaudited reference implementation | 194 tests passing (183 unit/configuration + 11 invariants) | Not production-ready
...
- [ ] All 194 tests passing locally, including the stateful invariants
