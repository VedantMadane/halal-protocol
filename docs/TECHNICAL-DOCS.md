...
**Status**: Unaudited reference implementation | 135 tests passing (132 unit/configuration + 3 invariants) | Not production-ready
...
# 1. Test locally
forge test -vvv
# Expected: 135/135 tests passing ✓
...
✓ 132 unit/configuration tests plus 3 stateful PSM invariants covering the core contracts and governance flows
...
- [ ] All 135 tests passing locally, including the stateful invariants
