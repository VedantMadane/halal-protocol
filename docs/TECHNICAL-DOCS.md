...
**Status**: Unaudited reference implementation | 178 tests passing (175 unit/configuration + 3 invariants) | Not production-ready
...
# 1. Test locally
forge test -vvv
# Expected: 178/178 tests passing ✓
...
✓ 175 unit/configuration tests plus 3 stateful PSM invariants covering the core contracts and governance flows
...
- [ ] All 178 tests passing locally, including the stateful invariants
