...
**Status**: Unaudited reference implementation | 174 tests passing (171 unit/configuration + 3 invariants) | Not production-ready
...
# 1. Test locally
forge test -vvv
# Expected: 174/174 tests passing ✓
...
✓ 171 unit/configuration tests plus 3 stateful PSM invariants covering the core contracts and governance flows
...
- [ ] All 174 tests passing locally, including the stateful invariants
