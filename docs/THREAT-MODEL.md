...
| A dependency address is an EOA or inert account | DAO, PSM, and CPI adapter constructors reject non-contract dependencies; deployment verifier also checks bytecode | Review the exact deployed bytecode and wiring before granting roles |
