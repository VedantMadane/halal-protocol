...
| Beneficiary address is mistyped or compromised | Two-step beneficiary acceptance; production deployment rejects a shared team/treasury beneficiary and deployer-controlled beneficiary; funds always release to the current beneficiary | A beneficiary that accepts a malicious address or loses its key cannot be rescued by the contract |
